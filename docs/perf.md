...
| 排名 | 语言 | 时间 (user) | vs C | 版本 |
|------|------|------------|------|------|
| 1 | C (-O2) | 0.043s | **1x** | Apple clang 21.0.0 |
| 2 | Bun | 0.041s | 0.95x | 1.3.13 |
| 3 | Node.js | 0.061s | 1.4x | v24.15.0 |
| 4 | **Zona 编译器** | **0.106s** | **2.5x** | — |
| 5 | Ruby | 0.440s | 10x | 2.6.10 |
| 6 | Python | 1.03s | 24x | 3.9.6 |
| 7 | **Zona 解释器** | **1.63s** | **38x** | — |
| 8 | Perl | 1.82s | 42x | — |

Zona 编译器居第四，在 C/Bun/Node 之后，优于 Ruby/Python/Perl。
