...
|------|------------|-----------------|
| C (-O2, double) | 0.027s | 0.06x (基准) |
| Node.js (V8 JIT) | 0.065s | 0.13x |
| **zona 编译器** | **0.48s** | **1x** |
| Ruby | 0.45s | 0.94x |
| Python | 1.05s | 2.2x |
| **zona 解释器** | **1.55s** | **3.2x** |
...
| 测试 | 解释器 | 编译器 | 加速比 |
|------|--------|--------|--------|
| fib(35) | 1.55s | 0.48s | **3.2x** |
| loop(10M) | 0.29s | 0.08s | **3.6x** |

编译器大约快 **3-4 倍**。

## 性能定位

zona 编译器的性能大致在 **Ruby 级别**，比 Python 快 2 倍，比 C 慢 18 倍，比 Node.js (JIT) 慢 7 倍。
